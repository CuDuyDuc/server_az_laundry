...
const { addProduct, getProduct, getProductByIdUser, getProductsByIdUserAndIdProductType, getProductByIdProduct } = require('../controllers/product_controller');
...
ProductRouter.get('/get-product-by-id-product', getProductByIdProduct);
